...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerPrefix(tokens.INT_LITERAL, p.parseIntegerLiteral)
	...
	p.registerInfix(tokens.TIMES, p.parseInfixExpression)
	p.registerInfix(tokens.DIVIDE, p.parseInfixExpression)
